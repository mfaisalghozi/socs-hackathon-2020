...
class IdeaSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('idea')->insert([
            ...
            ['userid' => 4, 'categoryid' => 3, 'ideaname' => 'Baling-Baling Baja', 'ideaimg' => 'baling.jpg', 'ideadescription'=>'Inilah baling-baling baja yang bisa memberikan beban dikepalamu dengan mudah.', 'ideatarget'=>'66600000', 'currentearning'=>'10000000', 'donatorcount'=>'666', 'ideadeadline'=>'2020-12-25', 'qa'=>'Apakah bisa dipakai untuk memukul pak guru? Tentu saja bisa hehe.'],
            ['userid' => 5, 'categoryid' => 3, 'ideaname' => 'kereta mini', 'ideaimg' => 'kereta.jpg', 'ideadescription'=>'Inilah kereta yang bisa dipakai untuk menjelajahi dunia bawah tanah.', 'ideatarget'=>'77000000', 'currentearning'=>'10000000', 'donatorcount'=>'777', 'ideadeadline'=>'2020-12-25', 'qa'=>'Apakah bisa dipakai untuk pergi keluar kota? Tentu saja bisa hehe.'],
        ]);
    }
}
